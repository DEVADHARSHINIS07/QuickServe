...
import { ShieldCheck, Mail, Lock, Eye, EyeOff, AlertCircle, CheckCircle2, Building2, ShieldAlert } from 'lucide-react';
...
export const AdminLoginPage: React.FC<AdminLoginPageProps> = ({ onNavigate, messageBanner }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      ...
      setTimeout(() => {
        // Redirect automatically to Admin Dashboard
    ...
    <div className="max-w-md mx-auto py-8 px-4">
      ...
      >
        ...
        <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 p-6 text-white text-center relative">
          ...
          <h2 className="text-2xl font-black mt-2 text-white">Canteen Admin Sign In</h2>
        ...
        <div className="p-6 space-y-5">
          <div className="p-3.5 bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 rounded-2xl flex items-center gap-2.5 text-xs text-amber-900 dark:text-amber-300">
            ...
            <div>
              <span className="font-bold block">Staff Security Clearance Required</span>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl text-xs sm:text-sm font-medium focus:outline-none focus:ring-2 focus:ring-amber-500"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-10 pr-10 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl text-xs sm:text-sm font-medium focus:outline-none focus:ring-2 focus:ring-amber-500"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between text-xs text-slate-600 dark:text-slate-400">
              <button
                ...
                className="text-amber-600 dark:text-amber-400 hover:underline font-bold ml-auto"
              >
                Forgot Password?
              </button>
            </div>
